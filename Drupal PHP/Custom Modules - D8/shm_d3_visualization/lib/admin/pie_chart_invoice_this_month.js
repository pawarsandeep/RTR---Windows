...
var svg = d3.select('#pie-chart-inivoice-this-month-admin')
	.append('svg')
	.attr('width', width+20)
	.attr('height', height+10)
	.append('g')
	.attr('transform', 'translate(' + (width-70) + ',' + (height/2) + ')');
var legend = d3.select("#pie-chart-inivoice-this-month-admin svg")
	.append("g")
...
var pie = d3.pie()
	...
	.sort(null);
d3.json('/rest-export/admin-invoice-this-month', function(error, data) {
	console.log(data);
	...
	g.on("mouseenter", function(d) {
		d3.select("#tooltip-admin-inivoice-this-month-pie-chart")
