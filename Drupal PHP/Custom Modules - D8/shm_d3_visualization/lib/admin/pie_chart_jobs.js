/**
 * @file Draws Jobs Pie Chart on Admin Dashboard.
...
var svg = d3.select('#pie-chart-jobs-admin')
	.append('svg')
	.attr('width', width+20)
	.attr('height', height+10)
	.append('g')
	.attr('transform', 'translate(' + (width-70) + ',' + (height/2) + ')');
var legend = d3.select("#pie-chart-jobs-admin svg")
	.append("g")
...
var pie = d3.pie()
	...
	.sort(null);
d3.json('/rest-export/admin-jobs-count', function(error, data) {
	console.log(data);
	...
	g.on("mouseenter", function(d) {
		d3.select("#tooltip-admin-jobs-pie-chart")
