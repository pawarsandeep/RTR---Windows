...
myColor myColorSaffron = { 1.0f,0.6f,0.2f, 0.0f };
myColor myColorFlagGreen = { 0.074f,0.533f,0.031f,0.0f };
DWORD dwStyle;
...
void DrawLetterD()
{
	...
	// Code
	DrawLine({ -1.0f,-4.0f,0.0f }, { -1.0f,4.0f,0.0f }, myColorFlagGreen, myColorSaffron, 5); // Left vertical line
	DrawLine({ -1.1f,-4.0f,0.0f }, { 1.0f,-4.0f,0.0f }, myColorFlagGreen, myColorFlagGreen, 5); // Bottom horizontal line
	DrawLine({ -1.1f,4.0f,0.0f }, { 1.0f,4.0f,0.0f }, myColorSaffron, myColorSaffron, 5); // Top horizontal line
	DrawLine({ 1.0f,-4.0f,0.0f }, { 1.0f,4.0f,0.0f }, myColorFlagGreen, myColorSaffron, 5); // Right vertical line
}
...
void DrawLetterA()
{
	...
	DrawLine({ -0.5f,0.05f,0.0f }, { 0.5f,0.05f,0.0f }, myColorSaffron, myColorSaffron, 2); // Middle horizontal Saffron line
	DrawLine({ -0.5f,0.0f,0.0f }, { 0.5f,0.0f,0.0f }, myColorWhite, myColorWhite, 2); // Middle horizontal White line
	DrawLine({ -0.5f,-0.05f,0.0f }, { 0.5f,-0.05f,0.0f }, myColorFlagGreen, myColorFlagGreen, 2); // Middle horizontal Green line
